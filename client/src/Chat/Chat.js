            ...
            <div className="flex justify-center items-center h-auto lg:h-screen flex-wrap mx-auto my-32 lg:my-0">
              ...
              >
                <div className="p-4 md:p-12 text-center lg:text-left">
                  ...
                  <h1 className="text-3xl text-center font-bold pt-8 lg:pt-0">
                    {provider.fname} {provider.lname}
                  </h1>
                  <p className="pt-4 text-base text-center  font-bold flex items-center justify-center ">
                    <svg
                  ...
                  <p className="pt-2 text-gray-600 text-center text-xs lg:text-sm flex items-center justify-center ">
                    <svg
                      className="h-4 fill-current text-green-700 pr-4"
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 20 20"
                    ...
                    Your Location : City - {provider.city} <br /> State -{" "}
                    {provider.state} , Pincode - {provider.pincode}{" "}
                  </p>
                  <div className=" pt-8">
                    ...
                    <div className="flex items-center">
                      {[...Array(5)].map((_, index) => (
                        <FaStar
                          key={index}
                          className={`h-5 w-5 ${
                            index < rated ? "text-yellow-500" : "text-gray-400"
                          }`}
                  ...
                  <div className="pt-12 pb-8 flex justify-center">
                    <button
                      ...
                      className="bg-green-700 hover:bg-green-900 text-white font-bold py-2 px-4 w-32 rounded-full"
                    >
                      Chat
                    </button>
                  </div>
