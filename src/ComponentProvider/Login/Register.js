                ...
                <div className="my-4 flex justify-center ">
                    ...
                    <div className="text-black flex flex-col justify-center">
                        ...
                        <form className=' ml-5 flex flex-col  justify-center py-6'>
                            ...
                            <div>
                                <div className="w-72 mr-5 mb-4 mt-3 border-black items-end gap-6">
                                    <input class="appearance-none block w-full  text-gray-700 border border-gray-600 rounded-lg py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white" type="number" placeholder="Enter Experience in Years" name="experience" required />
                                </div>
                            </div>
                            ...
                            <div className="flex flex-wrap  ">
                                ...
                                <div className=" flex w-72 mb-4 items-end">
                                    <input type={showPassword ? 'text' : 'password'} className="mt-1 block w-full rounded-md bg-gray-200 border-transparent  focus:border-gray-500 focus:bg-white focus:ring-0" value={userData.cpassword} name="cpassword" onChange={onChangeHandle} placeholder="Confirm Password" required />
                                    {userData.password && (
                                        <FontAwesomeIcon
                                            icon={showPassword ? faEyeSlash : faEye}
                                            className="eye-icon -ml-6 mb-3"
                            ...
                            <div className="flex justify-center pt-3 mr-24">
                                <input class="bg-transparent hover:bg-blue-500 text-blue-700 font-semibold hover:text-white py-2 px-4 border  border-blue-500 hover:border-transparent rounded-full" type="submit" onClick={onSubmit} required />
                            </div>
                        </form>
                    </div>
                </div>
